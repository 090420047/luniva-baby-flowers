        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 pb-16 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:pb-24">
          <div className="max-w-xl">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/modeller" className="inline-flex items-center justify-center rounded-xl bg-[#7e62a6] px-5 py-3.5 text-xs font-bold uppercase tracking-[0.12em] text-white shadow-lg shadow-[#7e62a6]/20 transition hover:-translate-y-0.5 hover:bg-[#70528f]">{"Modelleri g\u00f6r"}</Link>
