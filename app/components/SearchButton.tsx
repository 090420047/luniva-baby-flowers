...
export function SearchButton() {
  ...
  const results = useMemo<Result[]>(() => {
    ...
    const categories = productCategories
      ...
      .map((item) => ({ label: item.title, href: "/" + item.slug, type: "Model" }));
